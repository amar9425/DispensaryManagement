...
const ManageStaff=(props)=>{
    ...
    const fetchData = async()=>{
        props.showLoader()
        await axios.get(`${API}/api/auth/get-staff`, { withCredentials: true }).then((response)=>{
    ...
    const handleUpdate = async()=>{
        props.showLoader();
        await axios.put(`${API}/api/auth/update-staff/${clickedStaff?._id}`,inputField,{withCredentials:true}).then((response)=>{
    ...
    const handleAddStaff = async (e) => {
        ...
        await axios.post(`${API}/api/auth/add-staff`,inputField,{withCredentials:true}).then((resp)=>{
            console.log(resp);
    ...
    const handleDelete = async(id)=>{
        await axios.delete(`${API}/api/auth/delete-staff/${id}`,{withCredentials:true}).then((response)=>{
            filterOutData(id)
        }).catch(err=>{
            toast.error(err?.response?.data?.error);
        })
