...
const FacilityModal = (props)=> {
    ...
    const updateFacility = async()=>{
        await axios.put(`${API}/api/facility/update/${props.clickedItem._id}`,inputField,{withCredentials: true}).then((response)=>{
    ...
    const handleSubmit = async(e)=>{
        ...
        await axios.post(`${API}/api/facility/add`, inputField,{withCredentials: true}).then((response)=>{
            window.location.reload();
        }).catch((err)=>{
            toast.error(err?.response?.data?.error);
        })
